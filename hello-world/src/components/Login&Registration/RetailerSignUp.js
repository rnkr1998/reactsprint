      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} Validate>
          <Grid container spacing={2}>
            ...
            <InputLabel  variant="outlined" id="demo-simple-select-outlined-label">Category</InputLabel>
        <Select
           fullWidth
           variant="outlined"
        ...
        >
          ...
          <MenuItem value="Fertilizers">Fertilizers and Pesticides</MenuItem>
          <MenuItem value="Seeds">Seeds</MenuItem>
          <MenuItem value="Machinary and Tools">Machinary and Tools</MenuItem>
